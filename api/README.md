...
- Install and start the [MariaDB server](https://mariadb.org/download/). Update the [application file](src/main/resources/application.properties) with the database credentials if necessary
